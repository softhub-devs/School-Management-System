...
const FormModal = ({ table, type, data, id, relatedData }: FormContainerProps & { relatedData?: any }) => {
  ...
  const handleDelete = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      switch (table) {
        case "subject":
          await deleteSubject({ success: false, error: false }, { id: deleteId });
          break;
        case "class":
          await deleteClass({ success: false, error: false }, { id: deleteId });
          break;
        case "teacher":
          await deleteTeacher({ success: false, error: false }, { id: deleteId });
          break;
        case "student":
          await deleteStudent({ success: false, error: false }, { id: deleteId });
          break;
        case "exam":
          await deleteExam({ success: false, error: false }, { id: deleteId });
          break;
      }
